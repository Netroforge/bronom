...
const exactTechnicalText = '^(?:\\s*|Bronom|MCP|GitHub|Apache 2\\.0|IndexedDB|JS|CSS|GET|POST|PUT|PATCH|DELETE|OPTIONS|https://api\\.example\\.com/v1/\\*|\\{\"content-type\":\"application/json\"\\}|\\{\"ok\":false\\}|/ 255|0 / 0|· v|[.:+›↑↓←→·—↗%✦×]+|:\\d+)$'
