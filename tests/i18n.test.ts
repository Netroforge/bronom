...
describe('locale catalogs', () => {
  ...
  it('renders both languages with named interpolation', () => {
    expect(translate('en-US', 'updates.status.available', { version: '2.0.0' })).toBe('Bronom 2.0.0 is available')
    expect(translate('uk-UA', 'updates.status.available', { version: '2.0.0' })).toBe('Доступний Bronom 2.0.0')
  })
