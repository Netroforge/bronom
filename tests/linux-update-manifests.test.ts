...
const assets: LinuxUpdateAsset[] = [
  { name: 'bronom-2.18.1-x86_64.AppImage', sha512: 'x64-appimage', size: 101 },
  { name: 'bronom-2.18.1-amd64.deb', sha512: 'x64-deb', size: 102 },
  { name: 'bronom-2.18.1-x86_64.rpm', sha512: 'x64-rpm', size: 103 },
  { name: 'bronom-2.18.1-arm64.AppImage', sha512: 'arm-appimage', size: 201 },
  { name: 'bronom-2.18.1-arm64.deb', sha512: 'arm-deb', size: 202 },
  { name: 'bronom-2.18.1-aarch64.rpm', sha512: 'arm-rpm', size: 203 }
]

describe('Linux updater manifests', () => {
  it.each([
    ['x64', ['bronom-2.18.1-x86_64.AppImage', 'bronom-2.18.1-amd64.deb', 'bronom-2.18.1-x86_64.rpm']],
    ['arm64', ['bronom-2.18.1-arm64.AppImage', 'bronom-2.18.1-arm64.deb', 'bronom-2.18.1-aarch64.rpm']]
  ...
  it('fails the release when an architecture has duplicate package assets', () => {
    expect(() => buildLinuxUpdateManifest('2.18.1', 'arm64', [
      ...assets,
      { name: 'bronom-2.18.1-aarch64.AppImage', sha512: 'duplicate', size: 204 }
