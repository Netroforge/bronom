...
- Surface failures from native tab/page-menu actions and page-requested new windows in Bronom's top-window toast instead of failing only in the developer console.
