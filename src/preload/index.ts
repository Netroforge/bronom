...
import type {
  ...
  BrowserZoomOptions,
  BrowserPdfOptions,
  BronomPanelWindowApi,
  DetachablePanelId,
  PanelDock,
  PanelRedockRequest,
  BronomMcpApi,
  BronomCredentialsApi,
  BronomDownloadsApi,
...
const api: BronomApi = {
  ...
  moveTabToGroup: (tabId: string, groupId?: string) => ipcRenderer.invoke('browser:move-tab-to-group', tabId, groupId),
...
contextBridge.exposeInMainWorld('bronom', api)
const downloadsApi: BronomDownloadsApi = {
...
contextBridge.exposeInMainWorld('bronomDownloads', downloadsApi)
const bookmarksApi: BronomBookmarksApi = {
...
contextBridge.exposeInMainWorld('bronomBookmarks', bookmarksApi)
const historyApi: BronomHistoryApi = {
...
contextBridge.exposeInMainWorld('bronomBrowsingData', browsingDataApi)
const mcpApi: BronomMcpApi = {
...
contextBridge.exposeInMainWorld('bronomSettings', settingsApi)
const permissionsApi: BronomPermissionsApi = {
...
contextBridge.exposeInMainWorld('bronomPermissions', permissionsApi)
...
contextBridge.exposeInMainWorld('bronomUpdates', updatesApi)
const panelWindowApi: BronomPanelWindowApi = {
