...
export const COMMAND_PALETTE_COMMANDS: readonly CommandPaletteCommand[] = [
  ...
  { id: 'environment', label: 'Open Environment', description: 'Emulate network, cache, service workers, CPU, rendering, runtime, region, identity, and location', category: 'Current website', keywords: ['throttle', 'offline', 'slow 3g', 'disable cache', 'bypass cache', 'service worker', 'bypass service worker', 'pwa', 'data saver', 'save data', 'low data', 'disable javascript', 'no js', 'progressive enhancement', 'dark mode', 'print', 'forced colors', 'contrast', 'reduced motion', 'vision deficiency', 'color blindness', 'locale', 'language', 'timezone', 'time zone', 'user agent', 'geolocation'], websiteOnly: true },
  ...
  { id: 'keyboard-shortcuts', label: 'Show keyboard shortcuts', description: 'Review Bronom keyboard controls', category: 'Application', keywords: ['help', 'keys'] },
  { id: 'toggle-mcp-pause', label: 'Pause or resume agents', description: 'Control whether Bronom accepts new MCP commands', category: 'Application', keywords: ['mcp', 'safety', 'stop'] }
]
