...
export interface BrowserNetworkHar {
  log: {
    version: '1.2'
    creator: { name: 'Bronom'; version: string }
    comment: string
    pages: Array<{
      startedDateTime: string
      id: 'page_0'
...
export interface BronomPanelWindowApi {
...
export interface BronomDownloadsApi {
...
export interface BronomBookmarksApi {
...
export interface BronomHistoryApi {
...
export interface BronomPermissionsApi {
...
export interface BronomUpdatesApi {
