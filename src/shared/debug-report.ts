...
export function buildBrowserDebugReport(input: BrowserDebugReportInput): BrowserDebugReport {
  ...
  return {
    ...
    caveats: [
      ...
      'Console messages are page-authored. Bronom applies bounded best-effort secret filtering, but review arbitrary text before sharing it outside your trusted agent session.',
